...
const Experience = [
    ...
    },
    {
        ...
        role: 'Developer',
        description:
            "Developed Angular web apps for health insurance for India's largest private insurer.",
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-8'>
                            ...
                            <p style={{ textAlign: 'left' }}>
                                ...
                                <br />
                                <code>
                                    A frontend web developer by profession with
                                    proficiency in ReactJs ❤.
                                </code>
                                <br />
                                <br />
                                Hit me up for anything and everything tech
                                related, or if you want to see me talk about why
                                Samwise Gamgee is the real hero, not Frodo
                                Baggins.
                            </p>
                        </div>
                    </div>
            ...
            <div className='optional-section background-alt' id='certificate'>
                ...
                <div className='optional-section-block'>
                    <ul>
                        ...
                        <li>
                            Introduction to Self-Driving Cars by University of
                            Toronto on Coursera.
                        </li>
                        <li>
                            The Arduino Platform and C Programming by University
                            of California, Irvine on Coursera.
                        </li>
                        <li>Data Analysis with Python by IBM on Coursera.</li>
                        <li>
                            Build an E-commerce Dashboard with Figma on Coursera
                        </li>
                        <li>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-sm-5 social'>
                            <ul>
                                <li>
                                    <a
                                        href='https://github.com/zorgonide'
                                        target='_blank'
                                    >
                                        <i
